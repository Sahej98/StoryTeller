...
export const characters = {
  player: {
    name: 'You',
    sprite: '/images/the_asylum/sprites/main_char_sprite.png', // Placeholder for player sprite
  },
  ghost: {
    name: 'Lily',
    sprite: '/images/the_asylum/sprites/lily_char_sprite.png', // Placeholder for ghost child sprite
  },
  doctor: {
    name: 'Dr. Finch',
    sprite: '/images/the_asylum/sprites/doctor_char_sprite.png', // Placeholder for sinister doctor
  },
  director_echo: {
    name: "Director's Echo",
    sprite: '/images/the_asylum/sprites/_char_sprite.png', // Using the transparent echo sprite for his psychic presence
  },
  'Echo of Barlowe': {
  ...
  harris: {
    name: 'Harris',
    sprite: '/images/the_asylum/sprites/harris_char_sprite.png', // Wounded man
  },
  echo: {
    name: 'Echo',
